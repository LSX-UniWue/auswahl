...
class DataHandler:
    ...
    """
       Data handling class  corralling data generated by benchmarking of different wavelength selection methods
    """
    ...
    def __init__(self,
        ...
        self.measurement_data = pd.DataFrame(np.NaN * np.zeros((len(methods), measurement_index.shape[0]), dtype='float'),
                                             index=self.methods,
    ...
    def _register_selection(self,
                            ...
                            sample: int,
                            selection: list):
        self.selection_data.loc[(method, (dataset, n_features, sample))].selected_features = selection
    ...
    def get_regression_data(self,
        ...
        """
            ...
            Returns
            -------
            pandas multiIndex DataFrame. The frame corrals the methods in its index and a multiindex with levels
