...
def test_reproducible_run(data):
    ...
    selector1 = RandomFrog(n_features_to_select=2, n_iterations=100, random_state=np.random.RandomState(42))
    selector2 = RandomFrog(n_features_to_select=2, n_iterations=100, random_state=np.random.RandomState(42))
