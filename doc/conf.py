...
project = u'auswahl'
copyright = u'2022, Buckermann, Florian'
...
from auswahl import __version__
...
sphinx_gallery_conf = {
    ...
    'reference_url': {'auswahl': None}
}


def setup(app):
    # a copy button to copy snippet of code from the documentation
    app.add_css_file('js/copybutton.js')
